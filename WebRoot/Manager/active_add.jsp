...
<body bgcolor="#ffffff"><jsp:include page="mtop.jsp" />
	<form method="POST" action="active_config.jsp" name="form1">
		<table width="785" height="174" border="1" align="center"
			cellpadding="0" cellspacing="0" bordercolor="#FFFFFF"
			bordercolordark="#333333" bordercolorlight="#FFFFFF">
			<tr>
				<td width="100%" height="39"><div align="center">物流动态信息发布</div>
				</td>
			</tr>
			<tr>
				<td width="100%" height="37">标题： <input type="text"
					name="title" size="37"> * 标题最多能够填写50个字符.</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="100%" height="37">作者： <input type="text"
					name="author" size="37">
				</td>
			</tr>
			<tr>
				<td width="100%" height="16"><input type="submit" value="发布"
					name="B1" onClick="return check()"> <input type="reset"
					value="重写" name="B2"> &nbsp;&nbsp;&nbsp;<a
					href="active_select.jsp">返回</a></td>
			</tr>
		</table>
