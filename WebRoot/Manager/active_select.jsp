...
<body bgcolor="#ffffff">
	<table width="785" height="189" border="1" align="center"
		...
		<tr align="right">
			<td height="29" colspan="5"><a href="active_add.jsp">发布动态信息</a>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td height="32" align="center"><a
				href="active_show.jsp?id=<%=code%>">修改</a> <a
				href="active_delete.jsp?id=<%=code%>">&nbsp;删除</a>
			</td>
		</tr>
		<%
						if (!rs.next())break;	
