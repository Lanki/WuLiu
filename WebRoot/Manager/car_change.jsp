...
<title>CarMessage_change page</title>
</head>
...
<body bgcolor="#ffffff"><jsp:include page="mtop.jsp" />
	<form action="car_changeConfig.jsp" method="post" name="form1">
		<table width="785" border="1" align="center" cellpadding="0"
			...
			<%
				...
				sql = "select * from tb_CarMessage where Code="
			...
			<tr>
				...
				<td width="32%" height="34" align="center"><input type="text"
					name="numbers" size="20" value="<%=rs.getString("TradeMark")%>">
				</td>
				<td width="19%" height="34" align="center">车辆品名：</td>
				<td width="31%" height="34" align="center"><input type="text"
					name="carname" size="20" value="<%=rs.getString("Brand")%>">
				</td>
			</tr>
			<tr>
				<td width="18%" height="36" align="center">车辆类型：</td>
				<td width="32%" height="36" align="center"><input type="text"
					name="type" size="20" value="<%=rs.getString("Style")%>">
				</td>
				<td width="19%" height="36" align="center">车辆限量：</td>
				<td width="31%" height="36" align="center"><input type="text"
					name="loads" size="20" value="<%=rs.getString("CarLoad")%>">吨</td>
			</tr>
			<tr>
				<td width="18%" height="37" align="center">已使用：</td>
				<td width="32%" height="37" align="center"><input type="text"
					name="usetime" size="20" value="<%=rs.getString("UsedTime")%>">年</td>
				<td width="18%" height="37" align="center">驾驶员名称：</td>
				<td width="32%" height="37" align="center"><input type="text"
					name="name" size="20" value="<%=rs.getString("DriverName")%>">
				</td>
			</tr>
			<tr>
				<td width="19%" height="37" align="center">驾驶员驾龄：</td>
				<td width="31%" height="37" align="center"><input type="text"
					name="time" size="20" value="<%=rs.getString("DriverTime")%>">年</td>
				<td width="18%" height="36" align="center">驾驶证号码：</td>
				<td width="32%" height="36" align="center"><input type="text"
					name="number" size="20" value="<%=rs.getString("LicenceNumber")%>">
				</td>
			</tr>
			<tr>
				...
				<td width="31%" height="37" align="center">
					<%
						String trans = rs.getString("TransportStyle");
			...
			<tr>
				...
				<td width="32%" height="42" align="center"><input type="text"
					name="linkman" size="20" value="<%=rs.getString("LinkMan")%>">
				</td>
				<td width="19%" height="42" align="center">联系电话：</td>
				<td width="31%" height="42" align="center"><input type="text"
					name="phone" size="20" value="<%=rs.getString("LinkPhone")%>">
				</td>
			</tr>
			<tr>
  ...
  <%=rs.getString("Remark")%></textarea>
			...
			<tr>
				...
				<td width="31%" height="42"><%=code%><input type="hidden"
					name="code" value="<%=code%>"></td>
			</tr>
			<tr>
				<td width="18%" height="42" align="center">发布人：</td>
				<td width="32%" height="42" colspan="3"><input type="text"
					name="username" size="20" value="<%=rs.getString("UserName")%>">
				</td>
			...
			<tr>
				<td width="104%" height="40" colspan="4">
					<p align="center">
						<input type="submit" name="show" value="修改"
							onClick="return check()">&nbsp;&nbsp; <input
							type="submit" name="reset" value="重置">
				</td>
			</tr>
