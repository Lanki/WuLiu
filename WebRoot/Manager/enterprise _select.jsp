...
<body bgcolor="#ffffff">
	...
	<table border="1" width="784" align="center" cellpadding="0"
		...
		<tr>
			...
			<td width="17%" align="center" height="27"><a
				href="enterprise_xiangxi.jsp?id=<%=code%>">详细</a> &nbsp;<a
				href="enterprise_delete.jsp?id=<%=code%>">删除</a>
			</td>
		...
		<tr>
			<td width="784" height="30" colspan="9" align="right">
				...
				<table width="784" align="center">
					<tr>
						<td width="783" height="30" colspan="6" align="right">共<%=pagecount%>页&nbsp;&nbsp;
							<a href="enterprise_select.jsp?topage=<%=1%>">第一页</a> <a
							href="enterprise_select.jsp?topage=<%=showpage - 1%>">上一页</a> <a
							href="enterprise_select.jsp?topage=<%=showpage + 1%>">下一页</a> <a
							href="enterprise_select.jsp?topage=<%=pagecount%>">最后一页</a></td>
					</tr>
				</table></td>
		</tr>
