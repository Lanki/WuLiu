...
<body bgcolor="#ffffff"><jsp:include page="mtop.jsp" />
	...
	<form method="POST" action="goods_changeConfig.jsp" name="form1">
		<%
			...
			String sql = "select * from tb_GoodsMeg where ID="
					+ request.getParameter("id");
			ResultSet rs = stmt.executeQuery(sql);
			if (rs.next()) {
				code = rs.getInt("ID");
		%>
		<table width="785" height="561" border="1" align="center"
			...
			<tr>
				...
				<td width="18%" height="45" align="center">
					<p align="center">
						<font size="4">运输时间：</font>
					</p></td>
				<td width="30%" height="45">
					<p align="center">
						<input type="text" name="gtime" size="20"
							value="<%=rs.getString("TransportTime")%>">
					</p></td>
			</tr>
			<tr>
				<td width="20%" height="45" align="center">
					<p align="center">
						<font size="4">联系电话：</font>
					</p></td>
				<td width="36%" height="45">
					<p align="center">
			...
			<tr>
				...
				<td width="36%" height="40" colspan="3" align="left"><input
					type="text" name="time" size="20"
					value="<%=rs.getDate("IssueDate")%>">
				</td>
			</tr>
			<tr>
				...
				<td width="84%" height="78" colspan="3">
					<p align="left">
						<textarea rows="5" name="gremark" cols="80"><%=rs.getString("Remark")%></textarea>
					</p></td>
			</tr>
			<tr>
				...
				<td width="84%" height="74" colspan="3">
					<p align="left">
						<textarea rows="5" name="grequest" cols="80"><%=rs.getString("Request")%></textarea>
					</p></td>
			</tr>
			<tr>
				<td width="20%" height="40" align="center">
				...
				<td width="20%" height="74">
					<p align="center"><%=code%><input type="hidden" name="code"
							value="<%=code%>">
					</p></td>
			</tr>
			<tr>
				<td width="104%" height="40" colspan="4">
					<p align="center">
						<input type="submit" name="change" value="修改"
							...
							type="button" name="back" value="返回" onClick="history.back()">
				</td>
			</tr>
		</table>
		<%
