...
<html>
<head>
<title>Goods_change_config page</title>
</head>
<body bgcolor="#ffffff">
	<%!
		Date date = new Date();
	...
	<%
		...
		java.sql.Date gshowdate = new java.sql.Date(date.getYear(),
				date.getMonth(), date.getDate());
				
		conn = connection.getConnection();
		stmt = conn.createStatement();
		sql = "update tb_GoodsMeg set GoodsStyle='" + gclass
				+ "',GoodsName='" + gname + "',GoodsNumber='" + gcount
				+ "',GoodsUnit='" + gunit + "',StartProvince='"
				+ startProvince + "',StartCity='" + gstartcity
				+ "',EndProvince='" + endProvince + "',EndCity='"
				+ gendcity + "',Style='" + gtransstyle
				+ "',TransportTime='" + gshowdate + "',Phone='" + gphone
				+ "',Link='" + glink + "',IssueDate='" + gshowdate
