...
<body bgcolor="#ffffff"><jsp:include page="mtop.jsp" />
	<table width="785" height="123" border="1" align="center"
		...
		<tr>
			...
			<td height="35" align="center"><a
				href="member_change.jsp?id=<%=code%>">修改</a> <a
				href="member_delete.jsp?id=<%=code%>">删除</a>
			</td>
		</tr>
		<%
			if (!rs.next())
				...
				<table width="88%" align="center">
					<tr>
						<td width="104%" height="30" colspan="9" align="right">共<%=pagecount%>页&nbsp;&nbsp;
							...
							<a href="member_select.jsp?topage=<%=showpage + 1%>">下一页</a>&nbsp;&nbsp;
							<a href="member_select.jsp?topage=<%=pagecount%>">最后一页</a></td>
					</tr>
				</table>
			</td>
		</tr>
