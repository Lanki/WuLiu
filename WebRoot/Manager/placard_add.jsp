...
<body bgcolor="#ffffff"><jsp:include page="mtop.jsp" />
	<form method="POST" action="placard_showConfig.jsp" name="form1">
		<table width="785" height="174" border="1" cellpadding="0"
			cellspacing="0" align="center" bordercolor="#FFFFFF"
			bordercolordark="#333333" bordercolorlight="#FFFFFF">
			<tr>
				<td width="100%" height="39"><div align="center">公告信息发布</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="100%" height="16"><input type="submit" value="发布"
					...
					value="重写" name="B2"> &nbsp;&nbsp;&nbsp;<a
					href="placard_select.jsp">返回</a></td>
			</tr>
		</table>
