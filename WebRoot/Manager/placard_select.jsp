...
<body bgcolor="#ffffff"><jsp:include page="mtop.jsp" />
	<table width="785" height="117" border="1" align="center"
		...
		<tr>
			<td height="29" align="right" colspan="5"><a
				href="placard_add.jsp">发布公告信息</a>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td height="32" align="center"><a
				href="placard_change.jsp?id=<%=code%>">修改</a>&nbsp; <a
				href="placard_delete.jsp?id=<%=code%>">删除</a>
			</td>
		</tr>
		<%
			if (!rs.next())
				...
				<table width="786" align="center">
					<tr>
						<td width="786" height="30" colspan="9" align="right">共<%=pagecount%>页&nbsp;&nbsp;
							<a href="placard_select.jsp?topage=<%=1%>">第一页</a>&nbsp;&nbsp; <a
							href="placard_select.jsp?topage=<%=showpage - 1%>">上一页</a>&nbsp;&nbsp;
							<a href="placard_select.jsp?topage=<%=showpage + 1%>">下一页</a>&nbsp;&nbsp;
							<a href="placard_select.jsp?topage=<%=pagecount%>">最后一页</a></td>
					</tr>
				</table></td>
		</tr>
		<%
