...
return false;
			...
			<table width="786" border="1" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="32%" height="34">
						<input type="text" readonly="yes" name="numbers" size="20"
				...
				<tr>
					...
					<td width="31%" height="36">
						<input type="text" name="loads" size="20"
							value="<%=rs.getString("CarLoad")%>">
						吨
					</td>
				</tr>
				<tr>
					...
					<td width="32%" height="37">
						<input type="text" name="usetime" size="20"
							value="<%=rs.getString("UsedTime")%>">
						年
					</td>
					<td width="18%" height="37">
						驾驶员姓名
				...
				<tr>
					...
					<td width="31%" height="36">
						<input type="text" name="styles" size="20"
							value="<%=rs.getString("LicenceStyle")%>">
					</td>
					<td width="19%" height="37">
						运输类型
					</td>
					<td width="31%" height="37">
						<input type="text" name="transtyle" size="20"
							value="<%=rs.getString("TranspotStyle")%>">
					</td>
				</tr>
				<tr>
  ...
  <%=rs.getString("Remark")%></textarea>
				...
				<tr>
					...
					<td width="31%" height="42">
						<input type="hidden" name="numb" value="<%=code%>">
						<%=code%>
					</td>
				</tr>
				<tr>
					<tr>
						...
						<td width="32%" height="23" colspan="3"><%=rs.getString("UserName")%>
							...
							<input type="hidden" name="user" size="20"
