...
alert("您还未登录，不能浏览详细信息！！！");<%response.sendRedirect("login.jsp");%>
</script>
		<%
			}
		%><jsp:include page="top.jsp" />
		<table width="786" height="137" border="1" align="center"
...
alert("没有空车信息！！");
			...
			<tr>
				...
				<td width="11%" height="29" align="center"><%=rs.getString("CarLoad")%>吨
				</td>
				<td width="11%" height="29" align="center"><%=rs.getString("UsedTime")%>年
				</td>
				<td width="15%" height="29" align="center"><%=rs.getString("DriverTime")%>年
				</td>
				<td width="11%" height="29" align="center"><%=rs.getString("TransportStyle")%></td>
				<td width="12%" height="29" align="center">
					<a href="car_show.jsp?id=<%=n%>">详细</a>
				</td>
			</tr>
			<%
				if (!rs.next())
