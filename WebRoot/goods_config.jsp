...
<%
	...
	sql = "insert into tb_GoodsMeg values('" + gclass + "','" + gname
			+ "','" + gcount + "','" + gunit + "','" + startProvince
			+ "','" + gstartcity + "','" + endProvince + "','"
			+ gendcity + "','" + gtransstyle + "','" + gtime + "','"
			+ gphone + "','" + glink + "','" + gshowdate + "','"
			+ gremark + "','" + grequest + "','" + username + "')";
