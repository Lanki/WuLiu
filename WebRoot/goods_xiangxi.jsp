	...
	<table width="785" height="480" border="1" align="center"
		...
		<tr>
			...
			<td width="83%" height="1" align="center" colspan="3">
				<p align="left">
					<textarea rows="3" name="S1" cols="76"><%=rs.getString("Remark")%></textarea>
			</td>
		</tr>
		<tr>
			...
			<td width="83%" height="52" align="center" colspan="3">
				<p align="left">
					<textarea rows="3" name="S1" cols="76"><%=rs.getString("Request")%></textarea>
			</td>
		</tr>
		<tr>
			<%
		...
		<tr>
			<td width="100%" height="45" colspan="4" align="center"><a
				href="goods_change.jsp?id=<%=code%>">修改</a>&nbsp;&nbsp; <a
				href="goods_delete.jsp?id=<%=code%>">删除</a>
			</td>
		</tr>
