...
<html>
	...
	int code;%>
	<body bgcolor="#ffffff">
		<table width="100%" height="238" border="1" align="center"
			cellpadding="0" cellspacing="0" bordercolor="#FFFFFF"
			bordercolorlight="#333333" bordercolordark="#FFFFFF">
			<tr>
				<td width="100%" height="39">
					<p align="center">
						<font size="7" face="隶书">物流知识</font>
				</td>
			</tr>
			<%
				conn = connection.getConnection();
				stmt = conn.createStatement();
				sql = "select * from tb_Knowledge where ID="
			...
			<tr>
				<td width="100%" height="37">
					<font size="5">标题： <%=rs.getString("Title")%></font>
				</td>
			</tr>
			<tr>
				<td width="100%" height="37">
