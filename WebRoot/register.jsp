	...
	<center>
		<form method="POST" action="regist_config.jsp" name="form1">
			...
			<table width="100%" height="42" border="0" cellpadding="0"
				...
				<tr>
					<td valign="bottom"><table width="100" border="0"
							...
							<tr>
								<td><img src="image/21.jpg" width="791" height="35">
								</td>
							</tr>
						</table>
					</td>
			...
			<table width="791" height="205" border="0" cellpadding="0"
				...
				<tr>
					<td width="46%" align="left" height="27"><div align="right">用户名：</div>
					</td>
				...
				<tr>
					...
					<td width="54%"><input type="text" name="question" size="20">
					</td>
				</tr>
				<tr>
					<td width="46%" height="27"><div align="right">问题答案：</div>
					</td>
					<td width="54%"><input type="text" name="result" size="20">
					</td>
				</tr>
				<tr>
			...
			<table width="100" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td><img src="image/24.jpg" width="791" height="203">
					</td>
				</tr>
			</table>
		</form>
