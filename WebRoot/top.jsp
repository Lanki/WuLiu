...
<jsp:useBean id="countTime" scope="page" class="com.xy.CountTime" />
...
<table width="100%" height="32" border="0" cellpadding="0"
	...
	<tr>
		<td><table width="786" border="0" align="center" cellpadding="0"
				...
				<tr>
					<th width="189" height="31" align="center">&nbsp; <%=countTime.currentlyTime()%>
					</th>
					<th width="597" height="31" align="center"><a href="index.jsp"
						...
						class="a1">企业信息</a>&nbsp;|&nbsp;<a href="logout.jsp" class="a1">退出</a>&nbsp;|&nbsp;<a
						href="Manager/index.jsp" class="a1">后台管理</a>
					</th>
				</tr>
			</table>
		</td>
